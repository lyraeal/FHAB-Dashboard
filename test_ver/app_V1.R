...
server <- function(input, output, session) {
  ...
  observeEvent(input$foo, {
    ...
    RV$Clicks <- paste0(
      ...
      # "<br><br></div>",
      # "</b><ins>",
      # row$Landlord_Group, "</ins></b> is ranked <b>",
      # row$Ranking,
      # "</b> on our Worst Evictors List, with <b>", row$Yearly_Filings, "</b> average evictions filed per year and <b>", row$Total.Code.Violations.for.Landlord.Group, "</b> total code violations."
    )
